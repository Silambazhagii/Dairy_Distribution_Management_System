...
import DealersMasterPage from './pages/masters/DealersMasterPage';
...
function RoleGuard({ prefix, children }) {
  const { user } = useAuth();
        ...
        <ToastProvider>
          <Routes>
            ...
            <Route element={<AppLayout />}>
              ...
              <Route path="/masters/dealers" element={<RoleGuard prefix="/masters/dealers"><DealersMasterPage /></RoleGuard>} />
