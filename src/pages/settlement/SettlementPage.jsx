...
export default function SettlementPage() {
  ...
  const amountDue = totalCashSales; // Cash sales must be remitted
  ...
  const LineRow = ({ label, value, highlight, sub }) => (
              ...
              <div className="card-body">
                {spCollections.map((c) => (
                  <div key={c.id} className="flex justify-between py-1.5 border-b border-gray-50 last:border-0">
                    <span className="text-xs text-gray-600">{c.dealer} · {c.mode}</span>
