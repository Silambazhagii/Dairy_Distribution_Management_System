...
export default function StatCard({ title, value, icon: Icon, trend, trendLabel, color = 'blue', onClick }) {
  ...
  const trendColor = trend > 0 ? 'text-green-700 bg-green-50 ring-green-600/10' : trend < 0 ? 'text-red-700 bg-red-50 ring-red-600/10' : 'text-slate-500 bg-slate-50 ring-slate-600/10';
